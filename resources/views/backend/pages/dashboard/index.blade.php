        ...
        <div class="flex flex-col gap-4 h-full">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
                <div class="card card-layout-frame">
                    <div class="card-body">
                        <h6 class="font-semibold mb-4 text-sm">Products</h6>
                ...
                <div class="card card-layout-frame">
                    <div class="card-body">
                        <h6 class="font-semibold mb-4 text-sm">Customers</h6>
                        <div class="flex justify-between items-center">
                            <div>
                                <h3 class="font-bold">
                                    <span>$21,827.13</span>
                                            ...
                                            <div class="flex items-center gap-2">
                                                <span class="avatar avatar-rounded avatar-md">
                                                    <img
                                                        ...
                                                        src="{{ asset('backend/img/products/product-1.jpg') }}"
                                                        loading="lazy"
                                                    />
                                                </span>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-2">
                                                <span class="avatar avatar-rounded avatar-md">
                                                    <img
                                                        class="avatar-img avatar-rounded"
                                                        src="{{ asset('backend/img/products/product-3.jpg') }}"
                                                        loading="lazy"
                                                    />
                                                </span>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-2">
                                                <span class="avatar avatar-rounded avatar-md">
                                                    <img
                                                        class="avatar-img avatar-rounded"
                                                        src="{{ asset('backend/img/products/product-4.jpg') }}"
                                                        loading="lazy" 
                                                    />
                                                </span>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-2">
                                                <span class="avatar avatar-rounded avatar-md">
                                                    <img
                                                        class="avatar-img avatar-rounded"
                                                        src="{{ asset('backend/img/products/product-5.jpg') }}"
                                                        loading="lazy" 
                                                    />
                                                </span>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-2">
                                                <span class="avatar avatar-rounded avatar-md">
                                                    <img
                                                        class="avatar-img avatar-rounded"
                                                        src="{{ asset('backend/img/products/product-7.jpg') }}"
                                                        loading="lazy" 
                                                    />
                                                </span>
